/**
 * Command registry — single source of truth for all samstack commands.
 *
 * Dependency graph:
...
export const COMMAND_DESCRIPTIONS: Record<string, { category: string; description: string; usage?: string }> = {
  ...
  'eval':    { category: 'Inspection', description: 'Run JavaScript from file and return result as string (path must be under the OS temp dir or cwd)', usage: 'eval <file>' },
